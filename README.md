...
#### Methods: 
The script uses `arcpy` (ArcGIS) to read in a pre-generated geo-referenced albedo model (`ws_albedo`) covering the continental United Stated. The longitude and latitude of the observing site are used to extract the albedo value from the model corresponding to the given location.
